...
<?php do_action('wpdeals_before_customer_login_form'); ?>

<?php if (get_option('wpdeals_enable_myaccount_registration')=='yes') : ?>
...
<?php if (get_option('wpdeals_enable_myaccount_registration')=='yes') : ?>	
	...
	<div class="col-2">
		...
		<form method="post" class="register" autocomplete="off">
			...
			<p class="form-row">
				<?php $wpdeals->nonce_field('register', 'register') ?>
...
<?php do_action('wpdeals_after_customer_login_form'); ?>