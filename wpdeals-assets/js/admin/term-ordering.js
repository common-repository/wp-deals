...
jQuery(document).ready(function($) {
	...
	$("table.widefat.wp-list-table").sortable({
		...
		cursor: 'move',
		axis: 'y',
		placeholder: 'daily-deals-cat-placeholder',
		...
		update: function(event, ui) {	
			...
			$.post( ajaxurl, { action: 'wpdeals-term-ordering', id: termid, nextid: nexttermid, thetaxonomy: wpdeals_term_ordering_params.taxonomy }, function(response){		
